...
There are many, many versions of Monopoly within this data set. We'd like to look at this subset to see how they vary in popularity, both in terms of average rating and the number of ratings written for each. 
