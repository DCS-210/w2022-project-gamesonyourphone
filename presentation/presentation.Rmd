...
library("readxl")
read_excel("C:\\Users\\finnconway\\Desktop\\Gamesonyourphone?.xlsx")
```
...
- How do factors like playtime, game mechanics, and game categories impact the popularity of board games?
- What categories do games fit into, and how do they overlap?
- How have games changed over time, and how are older games perceived now?
