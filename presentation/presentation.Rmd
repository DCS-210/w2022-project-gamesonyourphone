...
```{r violin-plot, echo = F, warning = F, message = F, fig.alt = "", out.width = "70%", out.height= "70%"}
board_games %>% 
...
# JACKSON'S SLIDE
```{r best-boardgame, echo = F, warning = F, message = F, fig.alt = "", out.width = "70%", out.height= "70%"}
...
pointfig <- ggplot(data = best_boardgame, mapping = aes(x = average_rating, y = users_rated)) +
  ...
  geom_point(data = best_boardgame, mapping = aes(color = (year_published))) +
  labs(title = "Amount of users rated vs. rating of game",
       subtitle = "Colored by year published",
       x = "Average rating",
