...
board_games %>%
  ...
  subset(mechanic %in% c("Area Control / Area Influence", 
                         ...
                         "Tile Placement",
                         "Set Collection")) %>% 
  #mutate(median = median(average_rating, count = n())) %>% 
  fct_relevel(mechanics, "Set Collection", "Tile Placement","Hand Management", "Dice Rolling", "Modular Board", "Hex-and-Counter", "Card Drafting", "Variable Player Powers", "Area Control / Area Influence"),
```
